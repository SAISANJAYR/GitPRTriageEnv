...
Downloads rsd-06/pr-regression-audit-grpo-adapter-v2 and runs it against the ENV
to produce evaluation/post_training_v2/trained_summary.json for comparison.
"""
import os, json, re, statistics, requests
from huggingface_hub import snapshot_download

# ── Config ──────────────────────────────────────────────────────────────────
ADAPTER_REPO  = "rsd-06/pr-regression-audit-grpo-adapter-v2"
